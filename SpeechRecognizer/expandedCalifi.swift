...
import Foundation
import UIKit
class ArraysLanguage: ViewController {
    
    var correr = ViewController()
 
    
   var number = [["Cero", "Uno", "Dos", "Tres"],
                           ["Zero ","One","Two","Three"],
                           ["Zero", "Uno", "Due", "Tre"] ,
                           ["Zéro", "Un", "Deux", "Trois"],
                           [ "Null","Eins", "Zwei", "Drei", ],
   ...
   var poronga =  [["Cero", "Uno", "Dos", "Tres", "Cuatro", "Cinco", "Seis", "Siete", "Ocho", "Nueve", "Diez", "Once", "Doce", "Trece", "Catorce", "Quince", "Dieciseis", "Diecisiete","Dieciocho", "Diecinueve", "Veinte"],
